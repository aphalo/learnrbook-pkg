...
| my-data-dwn.xlsx |          |               |     |
| my-data.sav    | ????       | SPSS data file |    |
| my-data.xlsx   | ????       |             |       |
| pet_ltm.nc     | 2014       | meteorological | Data of Anders Lindfors, at FMI |
| pevpr.sfc.mon.ltm.nc | ???? | ???? | ???? |
| thiamin.sav    | ????       |           |         |

Do see the individual help pages for additional details on the data sets.
